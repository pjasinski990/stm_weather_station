##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.18.0-B7] date: [Sat Apr 15 12:00:30 CEST 2023] 
##########################################################################################################################
...
CFLAGS += $(MCU) $(C_DEFS) $(C_INCLUDES) $(OPT) -Wall -fdata-sections -ffunction-sections -DUSE_FULL_ASSERT
...
# libraries
LIBS = -lc -lnosys -LDrivers/bsec/bin -lalgobsec -lm
LIBDIR = 
